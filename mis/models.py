...
class Task(BaseContent):
    STATUS_CHOICES = ((1, 'Pending data entry'), (2, 'Submitted for Partner Admin'),(3, 'Submitted for Project In-charge'), (4, 'Approved'), (5,  'Rejected'))
    ...
    task_month = models.PositiveIntegerField(default=0)
